...
Status: design 2026-09-07; **fase 1 (læs og vis), fase 2 (gitter og regler) og
fase 3 (forslag, lås, benchmark) bygget 2026-09-07** på branchen `planner-fase1` (`planner/`, se `planner/README.md`).
