/**
 * Regler for et indtastet kampresultat — tællersidens "Indtast resultat".
 *
 * Samme logik som backend/config/kampResultat.js (serveren er den, der
 * afgør); her bruges den til at foreslå vinder og vise, om kampen er
 * fuldført eller afsluttet før tid, mens der tastes.
 * backend/tests/unit/kamp-resultat.test.js kører de samme tilfælde mod begge.
 *
 * Ren logik uden DOM — window.KampResultat i browseren, require() i tests.
 */
(function (root, factory) {
    if (typeof module === 'object' && module.exports) module.exports = factory();
    else root.KampResultat = factory();
