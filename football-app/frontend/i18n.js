...
(function () {
  ...
  const DICT = {
    ...
    'logo.sourceLibrary': { da: 'Bibliotek', en: 'Library' },
    'logo.sourceOnline': { da: 'Søg klubber online', en: 'Search clubs online' },
    'logo.onlineSearch': { da: 'Søg efter klub (fx Brøndby)...', en: 'Search for a club (e.g. Arsenal)...' },
    'logo.onlinePrompt': { da: 'Skriv en klubs navn for at søge online.', en: 'Type a club name to search online.' },
    'logo.onlineHint': { da: 'Logoer hentes fra TheSportsDB og gemmes i klubbens eget bibliotek.', en: "Logos are fetched from TheSportsDB and saved to the club's own library." },
    'logo.importFailed': { da: 'Kunne ikke importere logo: {msg}', en: 'Could not import logo: {msg}' },
    'logo.auto': { da: 'Automatisk (match på navn)', en: 'Automatic (match by name)' },
    'logo.noLogo': { da: 'Intet logo', en: 'No logo' },
    'logo.aliases': { da: 'Aliasser (valgfrit, kommasepareret)', en: 'Aliases (optional, comma-separated)' },
    'logo.aliasesPlaceholder': { da: 'fx LBK, Lyngby', en: 'e.g. LBK, Lyngby' },
